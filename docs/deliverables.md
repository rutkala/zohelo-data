...
- **Concrete remaining blocker:** GitHub PR creation returned an internal connector error twice; queries confirmed no PR existed at that checkpoint. The branch and evidence must be published/reviewed and merged before this increment is marked Done. No main or portal deployment is claimed. Issue #94 stays open through that handoff.
